...
/* ContactUpdatePage
 *  - Renders a contact form, for updating a contact.
 */
export default class ContatUpdatePage extends React.Component {
    constructor(props) {
        super(props)
        ...
        this.contact = Contact.findById(props.params.id)
    }
