...
/* ContactViewPage
 *  - Renders a contact view in a page.
 */
export default class ContactViewPage extends React.Component {
    constructor(props) {
        ...
        this.state = {
            contact: props.store.findContactById(props.params.id),
        }
    }
    ...
    onSendRequest (event) {
        this.props.router.replace('/transactions/create?to='+this.state.contact.accountNumber)
    }
    ...
    render() {
        return <div className="page">
            <ContactView
              ...
              onSendRequest={this.onSendRequest.bind(this)}
              onDeleteRequest={this.onDeleteRequest.bind(this)} />
        </div>
    }
}
