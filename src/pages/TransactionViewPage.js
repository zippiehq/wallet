...
/* TransactionViewPage
 *  - Renders a transaction view in a page.
 */
export default class TransactionViewPage extends React.Component {
    constructor(props) {
        super(props)
        ...
        this.transaction = Transaction.findById(props.params.id)
    }
    
    render() {
        return <div className="page">
            <TransactionView transaction={this.transaction} />
        </div>
    }
}
